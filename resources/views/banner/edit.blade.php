        ...
        <section id="banner" class="p-3" >
            <div class="container_xxl p-3">
                <div class="col-md-12 d-flex justify-content-between mb-3">
                    <h2 class="">編輯Banner</h2>
                </div>
                <div class="ps-5 pe-5">
                    {{-- enctype="multipart/form-data" --}}
                    <form class="form row g-3" action="/banner/update/{{$banner->id}}" method="post" enctype="multipart/form-data"> {{--需和route對應--}}
                        @csrf
                        {{-- 圖片 --}}
                            <div class="h6">目前banner圖片</div>
                            <img src="{{$banner->img_path}}" alt="" style="width: 100%; opacity:{{$banner->img_opacity}};" >

                            <label class="h6 mb-3" for="banner-img">選擇新的Banner圖片
                                <input type="file" name="img_path" id="banner-img">
                            </label>
                        {{-- opacity --}}
                            <label class="h6 mb-3" for="banner-opacity">透明度設定
                                <input type="text" name="img_opacity" id="banner-opacity"  value="{{$banner->img_opacity}}">
                            </label>
                        {{-- 權重 --}}
                            <label class="h6 mb-3" for="weight">權重設定
                                <input type="number" name="weight" id="weight" value="{{$banner->weith}}">
                            </label>
