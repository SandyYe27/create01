    ...
    @section('main')
        ...
        <section id="shopping-step03" class="pt-3 pb-3">
            ...
            <div class="ms-5 me-5 mt-5">
                <form class="form row g-3" action="/comment/update/{{$comment->id}}" method="GET"> {{--需和route對應--}}
                    <div class="col-md-6">
                        <label for="inputex1" class="form-label">標題</label>
                        <div>
                            <input type="text" class="form-control" id="inputex1" name="title" value="{{$comment->title}}" placeholder="{{$comment->title}}">
                        </div>
                    </div>

                    <div class="col-md-6">
                        <label for="inputex2" class="form-label">留言者姓名</label>
                        <div>
                            <input type="text" class="form-control" id="inputex2" name="name" value="{{$comment->name}}" placeholder="{{$comment->name}}">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div>
                            <input type="text" class="form-control" id="inputex3" name="content" value="{{$comment->context}}" placeholder="{{$comment->context}}" style="height: 200px" >
                        </div>
                    </div>
                    <div class="col-md-12 d-flex justify-content-between">
                        <input type ="button" onclick="location.href='/comment' " value="返回留言板" style="width: 130px;height: 50px;">
