...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-MSVX084FSB"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-MSVX084FSB');
    </script>
            ...
            <div class="navbar-right-button gap-4 d-md-flex">
                ...
                {{--如果有登入，看到user您好，和登出鍵--}}
                    ...
                    <li class="list-unstyled">
                        <a class="d-flex flex-wrap h6" style="width:100px;padding-top:16px;">{{ Auth::user()->name }}, 您好</a> {{--用 Auth::user()->name 調出使用者資料，如名字、信箱 --}}
                    </li>
                    <li class="list-unstyled">
                        <a href="" onclick="event.preventDefault(); document.querySelector('#logout_form').submit()"><button class="btn h6">登出</button></a>
                ...
                @guest
                    <a href="/login">
                        <button class="btn h6 d-flex">
                            <i class="h3 bi bi-person-circle align-self-center mt-2"></i>
                            &nbsp;
                            <span class="align-self-center">登入</span>
                        </button>
                    </a>
                    ...
                    {{-- <button style="border: 0; background-color:white;">
                        <a href="/login" class="d-flex">
                            ...
                            <span class="ms-1 h6" style="margin-top: 12px">登入</span>
                        </a>
                    </button> --}}
                @endguest
    ...
    <footer>
        ...
        <section class="footer-bottom">
            <div class="container_xxl d-flex" style="background-color: rgb(223, 227, 232);">
                <div> © 2022 BackendHomework — @SandyYe</div>
                <div>
